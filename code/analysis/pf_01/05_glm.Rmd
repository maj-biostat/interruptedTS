...
For this attempt at modelling seasonality use a harmonic series. This essentially uses a combination of sine and cosine functions to produce smooth rather than spikey transitions across the seasons. The downsides are around the difficulty in identifying correct periodicity, amplitude etc. Generally, people just do this using AIC or other measure of fit. It they want to get clever then they tackle periodograms.

A couple of links for ref.

https://s3.amazonaws.com/assets.datacamp.com/production/course_3002/slides/ch5.pdf

https://stats.stackexchange.com/questions/77080/question-about-eliminating-seasonality


```{r, echo = T, eval = T}
d1 <- readRDS("dat_clean//d_seas1.RDS")
...
saveRDS(d1, "dat_clean\\d_seas2.RDS")
```
...
Seasonality introduced via harmonic series. We'll come back to seasonality later.
