...
Last time we fit GLARMA models using poisson distributional assumptions. The PITs looked bad so here we use negative binomial. Now we use harmonic for modelling seasons.
...
fit1 <- function(x){
  ...
  lm2 <- glarma(y, mX, offset = mOffset,
              ...
              beta = coef(lm1),
              method = "FS",
              residuals = "Score", maxit = 1000, grad = 2.22e-8)
...
See https://jrnold.github.io/ssmodels-in-stan/
