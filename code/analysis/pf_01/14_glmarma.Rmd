...
Figure 1 shows the observed and fitted values for each age class. The gap in the fitted values represents the data in the first year of vaccination that was excluded from the models (from Jul 2007 to Jun 2008 inclusive).
